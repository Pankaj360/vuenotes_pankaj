  ...
  <div id="app">
    <header>
      <span>Vue.js Pankaj Notes
       ...
       <b-button class="float-right" @click.prevent="laugh" v-if="loggedInUser">Make me laugh</b-button>
       <b-button class="float-right" @click.prevent="notes" v-if="loggedInUser">Notes</b-button>
